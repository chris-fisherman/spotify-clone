  ...
  return (
    <footer className='main-footer'>
      <div className='main-footer__body'>
        <div className='main-footer__body-links'>
          <section>
            <h2>Company</h2>
            <ul>
              <li>
          ...
          <section>
            ...
            <ul>
              ...
              <li>
                <Link to='#'>Family Premium</Link>
              </li>
              <li>
                <Link to='#'>Premium for Students</Link>
              </li>
              <li>
        ...
        <ul className='main-footer__body-social-media'>
          <li>
      ...
      <div className='main-footer__copyright'>
        <p>© 2025 This is just a practice project</p>
      </div>
    </footer>
  );
};
